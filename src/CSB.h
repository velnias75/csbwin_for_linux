...
public:
  ...
  i16 w6_4_15(void) {ASSERT((word4&0x800)!=0,"No Target");return (i16)BITS4_15(word6);};
  ...
  i16 w4_b11(void) {return (i16)BITS11_11(word4);};
...
public:
  ...
  ui32 timerTime; // Top 8 bits=partyLevel, bottom 24 bits = time
...
private:
  ui8  uByte6;// subtracted from 255 --> TIMER.byte5..ticks per movement?
public:
  ui8  uByte7;
...
public:
  ...
  ui8 timePerMove(void)      const {return uByte6;};
};
...
void NotImplemented(i32 i=0);
void SorryNotImplemented(i32 i=0);
void HopefullyNotNeeded(i32 i=0);
//i16& wordGear(pnt p);
//i16& wordGear(ui8 *p);
...
pnt  dosound(pnt P1); // Start sound stream
...
void ClearMemory(pnt dest, i32 numByte); // TAG000a84
void fillWithByte(pnt addr, i16 num, i8 value, i16 spacing);//TAG000ac0
...
void BLT2Viewport(pnt, RectPos *, i16, i16);//TAG000f4a
void BLT2Screen(pnt P1, RectPos *P2, i16 P3, i16 P4);//TAG000f7e
...
void GetIconGraphic(OBJ_NAME_INDEX, pnt); //TAG00135c
...
void PrintLines(i32 color, const pnt text);//TAG001aa8
...
//      001ce8 = TRAP 14
//      001cf8 = TRAP 1
void StartSound(pnt P1, i32 P2, i32 highVolume); // TAG001d16
...
pnt  StrCat(pnt str1, const char *str2);//TAG0031e8
i16  StrCmp(pnt, pnt);//TAG003222
void StrCpy(pnt dst, const char *src);//TAG003264
pnt  StrCpy(pnt dest, const char *src, i16 numChar); //TAG00327c
...
void BltShapeToViewport(pnt P1, RectPos *P2);//TAG00437e
void BltRectangleToViewport(pnt src, RectPos *P2);//TAG0043c4
void BltTempToViewport(RectPos *);//TAG00440a
void MirrorShapeBltToViewport(pnt P1, RectPos *P2);//TAG004450
...
void ShrinkBLT(pnt src,
               ...
               i32 dstHeight,
               ui8 *pColorMap);
void Mirror(pnt bitmap, i32 width/*bytes*/, i32 height); //TAG008642
void TAG008840(pnt, i16, i16);
...
void TAG008c98(pnt,
               ...
               i16,
               i16);
void Flood(pnt dst,   //TAG008e1c
           i16 color,
           i16 num); // number of 16-bit groups
//   TAG008e60
void FillRectangle(pnt, RectPos *, i32 color, i32 destWidth);
...
i32 DecodeText(pnt rslt,DB2 *pText,i16 typeOfText, i32 max); //TAG00a27c
...
i32  EncodeDescriptivePhrases(i32, i32, pnt *, i32 *, pnt, const char*, const char*);//TAG017ece
void SelectPaletteForLightLevel(void);//TAG017fa8
void NinetySecondUpdate(void);//TAG018124//(void)
void TAG018238(i16);
void DisplayScrollText_OneLine(i16, pnt);//TAG01826c
...
void SubstDiskLetter(pnt dest,const char *src, i16 flag);//TAG01cefa
...
//   TAG01d0a4
i16  UnscrambleStream(pnt buf,i32 size,i16 initialHash,i16 Checksum);
i16  WriteScrambled(pnt, i32, i16, i16 *);//TAG01d0ea
i16  FetchDataBytes(pnt dest, i16 *checksum, i32 numbyte); //TAG01d138
...
RESTARTABLE _WaitForMenuSelect(const i32 P1,
                       ...
                       const i32 P3,
                       const i32 P4); //(i16)
void CenteredText(pnt dest, const char *text, i16 x, i16 y);//TAG01d5aa
//   TAG01d5ee
i16  SplitLongLine(pnt text, pnt firstLine, pnt secondLine);
#define DoMenu(n,a,b,c,d,e,f,g,h,i) CALL9(n,DoMenu,a,b,c,d,e,f,g,h,i)
RESTARTABLE _DoMenu(
            const pnt title1,  //TAG01d678 (void)
            const pnt title2,
            const char *opt1,
            const char *opt2,
            const char *opt3,
...
i16  ReadUnscrambleBlock(pnt P1);//TAG01db46
...
void DisplayHeroName(i16, i16, i16, pnt); //TAG01f990
...
void TAG02134a(pnt);
//   TAG0213ec //
void ExpandGraphic(pnt src, // 1st 2 words are width and height.
                   pnt dst, // If NULL then physbase.
                   i16 dstX, // Ignored if dst != NULL
                   i16 dstY,//   or if graphic width==320
                   i32 maxSize = 999999);
i32  LocateNthGraphic(i32 n); //TAG021714
pnt  allocateMemory(i32 size, i16 type); //TAG02175c
...
void ReadGraphic(i16 graphicNumber, pnt buffer, i32 maxSize=999999); // TAG021af2
//   TAG021c08
void InitializeCaches(pnt P1, i32 P2, pnt P3, i32 P4);
void TAG021cd8(void);
...
i32  LZWExpand(i16 handle, i32 graphicSize, pnt dest, pnt scratch, pnt stack); //TAG022f64
...
RESTARTABLE _UtilityDialogBox(pnt msg, i32, pnt, struct S12406 *);//(i16)
...
RESTARTABLE _TAG000ede(i32, pnt);//(i16)
