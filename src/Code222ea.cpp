...
//  i16 wLOCAL_14;
  ...
  for (D7W=0; D7W<count; D7W++)
  {
    ...
    while (  ((D6W=sw(D7W+1)) < count)
           &&(D5W == P1[D6W]) )
    {
    MemMove((pnt)&P1[D6W], (pnt)&P1[D7W], 2*((count--)-D6W));
  ...
  if (d.Word23328 != 0)
  {
    iLOCAL_8 = d.Pointer23310 - iLOCAL_4 - d.pStartMemory;
  }
  else
  {
    iLOCAL_8 = d.pStartAvailMemory - d.pStartMemory;
  };
  A0 = d.LogicalScreenBase;
  longGear(A0+32000) = iLOCAL_8;
  if (iLOCAL_8 < 19576)
  {
...
//
  ...
  pLOCAL_12 = allocateMemory(5004,0);
//  while (d.Word23228 != 0) {};
  for (D7W=0; D7W<count; D7W++)
  {
    D5W = P1[D7W];
...
//
  ...
  d.Pointer23314 = A2;
  if (d.Word23328 != 0) d.pStartAvailMemory = d.Pointer23314;
  TAG021234();
  FreeTempMemory(5004);
  return;
}
