...
//;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ...
  else
  {
    ...
    if (D0W != 0)
    {
      A3 = GetDerivedGraphicAddress(D4W);
    }
    else
    {
      ui8 *pColorMap;
      pnt_4 = (pnt)GetBasicGraphicAddress(Smaller(D7W, 2)+348);
      if (D7W == 3)
      {
      ...
      ShrinkBLT(pnt_4,                //src
                A3 = GetDerivedGraphicAddress(D4W),//dst
    ...
    if (D4W < 136)
    {
      ...
      if (D4W >= 0)
      {
        ...
        if (rect_42.b.x2 > rect_42.b.x1)
        {
          ...
          if ( (LOCAL_36!=0) || (w_142) )
          {
            MemMove(A3, (i8 *)tempBitmap, LOCAL_22*LOCAL_24);
            A3 = (i8 *)tempBitmap;
          };
          if (LOCAL_36 != 0)
          {
            Mirror(A3, LOCAL_22, LOCAL_24);
          };
          if (w_142)
          {
            TAG008840(A3, LOCAL_22, LOCAL_24);
          };
          TAG0088b2((ui8 *)A3,
                    (ui8 *)d.pViewportBMP,
                    &rect_42,
  ...
  for (;;)
  {
    ...
    if (pMonsterXYonScreen_16[1] != 0)
    {
      ...
      if (RelativeCellNumber >= 6) // a//Within one cell of us
      {
        ...
        if (showSideView_98) //b
        {
          ...
          if (MonsterRelFacing_74 == 1)
          {
            MakeMirror(A3, (i8 *)tempBitmap, dstByteWidth, dstHeight);
            A3 = (i8 *)tempBitmap;
          };
        }
        else //b not side view
        {
          ...
          else
          {
            ...
            if (D0W)
            {
              A3 = GetDerivedGraphicAddress(graphicNumFBSAE);
            }
            else
            {
    ...
    //
      ...
      { // RelativeCellNumber <= 5 (two or more rows ahead)
        ...
        {
          LOCAL_12 = (pnt)GetBasicGraphicAddress(graphicNum0);
          ShrinkBLT(LOCAL_12,                                        // src
                    A3 = GetDerivedGraphicAddress(graphicNumFBSAE),    // dst
...
*/
             ...
             || frontViewMirror_106 && !mtDescWord4_76.NonAttackingMirrorOK() )
        {
          if ( !frontViewMirror_106 || (!derivedGraphicAlreadyExists) )
          {
            ...
            if (!frontViewMirror_106)
            {
              MemMove(A3, (i8 *)tempBitmap, (ui16)D4W*(ui16)dstHeight);
              A3 = (i8 *)tempBitmap;
            };
            Mirror(A3, D4W, dstHeight);
          };
//tag005ed0:
...
//  ui8  *uA3;
      ...
      || ( (RelativeCellNumber>=6) && nearSideOfCell ) ) // Near side of F1 row
  {
    ...
    distanceFromUs_52 = 0;
    A3 = (pnt)GetBasicGraphicAddress(graphicNum_D4);
    width_LOCAL_22 = (UI8)(pGraphicClass->width);
    height_LOCAL_24 = (UI8)(pGraphicClass->height);
    if (LOCAL_36)
    {
      MakeMirror(A3, (i8 *)tempBitmap, width_LOCAL_22, height_LOCAL_24);
      A3 = (i8 *)tempBitmap;
    };
  }
  else
  {
    ...
    if (D0W)
    {
      A3 = GetDerivedGraphicAddress(w_18);
    }
    else
    {
      ...
      A3 = GetDerivedGraphicAddress(w_18);
   //   if (
      ShrinkBLT(pSrcGraphic_LOCAL_12,            //src
               A3,                               //dest
  ...
  if (touchable)
  {
    ...
    if (pButtonDef->x1 == 255)
    {
      ...
      MemMove((pnt)&rect_42, (pnt)pButtonDef, 4);
  ...
  */
  ...
  tag0063be:
    ...
    { 
      ...
      if (A3 != (i8 *)tempBitmap)
      {
        MemMove(A3, (i8 *)tempBitmap, D4W * LOCAL_24);
        A3 = (i8 *)tempBitmap;
      };
      if (w_142 != 0)
      {
        TAG008840(A3, D4W, LOCAL_24); // pnt, width, height??
      };
      if (LOCAL_36 != 0)
      {
        Mirror(A3, D4W, LOCAL_24);//pnt,width,height??
      };
    };
...
//tag0065bc:
  ...
  if ( (pdb_150!=NULL) && (sideOfDoor!=SOD_FarSideOfDoor) && (d.Word1868==0) )
  {
    ...
    MemMove((pnt)&d.teleporterRectangles[RelativeCellNumber], (pnt)&b_170, 8);
    b_170.b.x1++;
...
void TAG008840(pnt P1,i16 width, i16 height)
{
  dReg D6, D7;
  aReg A0, A1;
  i32 D7U, dA2;
...
//;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ...
  do
  {
    ...
    do
    {
      D7U -= 3;
      if (D7U < 0) break;
      memmove(temp24,A0,24);
      memmove(A0, A1, 24);
      memmove(A1, temp24 ,24);
      A1 += 24;
      A0 += 24;
    } while (D7U != 0);
