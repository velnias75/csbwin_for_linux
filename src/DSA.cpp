...
static void EX_DEL(void)
{
  ...
  //case dbACTUATOR:
  case dbEXPOOL:
    NotImplemented(); //Need to remove possessions, etc.
    break;
  };
  ...
  case STKOP_ParamFetch:
    {
      ...
      if (pdsaDbank->tracing)
      {
        ...
        for (i=0; i<n; i++)
        {
          sprintf(l," %d",pDSAparameters[1+i]);
          PrintTrace(l);
        };
        PrintTrace("}");
      };
  ...
  case STKOP_GetCurse:
    {
      ...
      objIndex = pdsaDbank->stack.pop();
      if (obj.checkIndirectIndex(objIndex))
      {
        obj.ConstructFromInteger(objIndex);
        switch(obj.dbType())
        {
        case dbWEAPON: 
            result = GetRecordAddressDB5(obj)->cursed();
            break;
        case dbCLOTHING: 
            result = GetRecordAddressDB6(obj)->cursed();
            break;
        case dbMISC: 
            result = GetRecordAddressDB10(obj)->cursed();
            break;
  ...
  case STKOP_GetBroken:
    {
      ...
      if (obj.checkIndirectIndex(objIndex))
      {
        ...
        {
        case dbWEAPON: 
            result = GetRecordAddressDB5(obj)->broken();
            break;
        case dbCLOTHING: 
            result = GetRecordAddressDB6(obj)->broken();
            break;
        default: break; //result is 0
        };
      };
  ...
  case STKOP_SetBroken:
    {
      ...
      if (obj.checkIndirectIndex(objIndex))
      {
        ...
        {
        case dbWEAPON: 
            GetRecordAddressDB5(obj)->broken(broken);
            break;
        case dbCLOTHING: 
            GetRecordAddressDB6(obj)->broken(broken);
            break;
        default: break;
        };
      };
  ...
  case STKOP_GetPoisoned:
    {
      ...
      if (obj.checkIndirectIndex(objIndex))
      {
        ...
        {
        case dbWEAPON: 
            result = GetRecordAddressDB5(obj)->poisoned();
            break;
        //case dbCLOTHING: 
        //    result = GetRecordAddressDB6(obj)->poisoned();
        //    break;
        default: break; //result is 0
        };
      };
  ...
  case STKOP_SetPoisoned:
    {
      ...
      if (obj.checkIndirectIndex(objIndex))
      {
        ...
        {
        case dbWEAPON: 
            GetRecordAddressDB5(obj)->poisoned(poisoned);
            break;
        //case dbCLOTHING: 
        //    GetRecordAddressDB6(obj)->poisoned(poisoned);
        //    break;
        default: break;
        };
      };
  ...
  case STKOP_GetCharges:
    {
      ...
      if (obj.checkIndirectIndex(objIndex))
      {
        ...
        {
        case dbWEAPON: 
            result = GetRecordAddressDB5(obj)->charges();
            break;
        case dbCLOTHING:
            result = GetRecordAddressDB6(obj)->charges();
            break;
        case dbPOTION:
            result = GetRecordAddressDB8(obj)->strength();
            break;
        case dbMISC:
            result = GetRecordAddressDB10(obj)->value();
            break;
        default: break; //result is 0
        };
      };
  ...
  case STKOP_SetCharges:
    {
      ...
      if (obj.checkIndirectIndex(objIndex))
      {
        ...
        {
        case dbWEAPON: 
            GetRecordAddressDB5(obj)->charges(charges);
            break;
        case dbCLOTHING:
            GetRecordAddressDB6(obj)->charges(charges);
            break;
        case dbPOTION:
            GetRecordAddressDB8(obj)->strength(charges);
            break;
        case dbMISC:
            GetRecordAddressDB10(obj)->value(charges);
            break;
        default: break;
        };
      };
  ...
  case STKOP_GetSubType:
    {
      ...
      if (obj.checkIndirectIndex(objIndex))
      {
        ...
        {
        case dbMISC:
            result = GetRecordAddressDB10(obj)->subType();
            break;
        default: break; //result is 0
        };
      };
  ...
  case STKOP_SetSubType:
    {
      ...
      if (obj.checkIndirectIndex(objIndex))
      {
        ...
        {
        case dbMISC:
            GetRecordAddressDB10(obj)->subType(subType);
            break;
        default: break;
        };
      };
  ...
  case STKOP_PartyDistance:
    {
      ...
      locr.Integer(pdsaDbank->stack.pop());
      if (d.partyLevel == locr.l)
      {
        pdsaDbank->stack.push(abs(d.partyX-locr.x) + abs(d.partyY-locr.y));
      }
      else
      {
        pdsaDbank->stack.push(-abs(d.partyLevel-locr.l));
      };
      break;
    };
