...
struct DBank {
  ...
  pnt Pointer23322;  // Start of remainder of static memory.
  pnt Pointer23318;  // Next available memory location.  Increments as memory allocated.
  pnt Pointer23314;
  pnt Pointer23310;
  ...
  pnt pEndOfAvailMemory;//pnt Pointer23298;  // Address of end of avail 'malloc' memory.
  pnt Pointer23294;  // Address of end of 'malloc' memory
  pnt Pointer22968; // Graphic #534
  pnt Pointer22964; // Graphic #535
  pnt Pointer22960; // Graphic #5
  pnt Pointer22956; // Graphic #4 Prison entrance minus door
  pnt Pointer22952; // Graphic #2 Prison door - left
  pnt Pointer22948; //  ShrinkBLT (Graphic #2)
  pnt Pointer22944; //  ShrinkBLT (Graphic #2)
  pnt Pointer22940; //  ShrinkBLT (Graphic #2)
  pnt Pointer22936; // Graphic #3 Prison door - right
  pnt Pointer22932; //  ShrinkBLT (Graphic #3)
  pnt Pointer22928; //  ShrinkBLT (Graphic #3)
  pnt Pointer22924; //  ShrinkBLT (Graphic #3)
  pnt Pointer22920;
  pnt Pointer22916; // Prison dungeon interior
  ...
  i8  IOBuffer[12]; // (23378)how big should this be????? At least 9!
  i16 Word23366;
  ...
  pnt ClusterCache;  // (23288) Pointer to 1024 bytes
  pnt pStartAvailMemory;// Pointer23284;  // 10000 below initially allocated memory blocks
                        //This is also the end of graphic memory.
  pnt pStartMemory;  // Start of memory.
  ...
  pnt SavedCursorPixels; //Pointer23198;
  pnt ScreenCursorAddress;// Area saved uder cursor//Pointer23194;
  pnt Pointer23190;
  pnt Pointer23186;
  pnt Pointer23182;
  pnt Pointer23178;
  pnt CursorBitmap; //Pointer23174; Adjusted to be on word boundary
  ...
  pnt Pointer12926;
  pnt newTextLine; //12922
           // This line contains the text bitmap to
           // be scrolled into the bottom of the
           // screen. 12916 is set to 0 to get the
           // process started. (qv)
  pnt ObjectNames[199];//12786;
  ui32 RandomNumber;      // 11986  Initially set from GEMDOS Random function
  pnt LogicalScreenBase; // 11982
  pnt compressedGraphic0;//Pointer11782; // Graphic zero?? Menu graphic?
  pnt pViewportBMP; //11682; // 15232 bytes - This is an image of the
  ITEM16 *pI1613134;
  i32 Time13130;
  ...
  pnt pViewportFloor;   //2082 - 7840 byte  //Address of floor in viewportBMP
  pnt pViewportBlack;   //2078 - 4144 bytes //Address of space between floor
                                            // and ceiling in viewportBMP
  pnt pCeilingBitmap;   //2074 - 3248 bytes
  pnt pFloorBitmap;     //2070 - 7840 bytes
  ...
  ITEM16 *Item16;  //13010; // Word13012  16-byte units?
                   ...
                   // active entries.
  i32 WatchdogTime;//13006; // Always one TIMER in queue.
...
//************Only 32-bit variables above this line
  ...
  FILL(22990,22988)
  pnt Pointer22988; // Set to "DRIVE."
  pnt Pointer22984; // Set to "DRIVE."
  pnt Pointer22980;
  pnt SaveGameFilename;//22976;
  i16 Word22972;
