...
//   TAG000f4a
void BLT2Viewport(pnt P1,RectPos *rectPos,i16 P3,i16 P4)
{
//;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
//;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ...
  d.UseByteCoordinates = 0;  
  MemMove((pnt)&d.PrimaryButtonList[d.Word11764-1].xMin, 
          (pnt)&rect34, 8);
  rect34.w.x1 -= 3;
  rect34.w.x2 += 3;
  rect34.w.y1 -= 3;
  ...
  TAG0088b2((ui8 *)d.LogicalScreenBase, 
            ...
            -1);
  wvbl(_2_);
  MemMove((pnt)&rect34, (pnt)&rect26, 8);
...
//   TAG01d5aa
void CenteredText(pnt dest, const char *text, i16 x, i16 y)
{
  dReg D0;
//;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  if (text == NULL) return;
            ...
            const i32 FadeOldScreen) //36
{
  ...
  static i8   LOCAL_100[50];
  static i8   LOCAL_50[50];
  RESTARTMAP
    RESTART(1)
    RESTART(2)
    RESTART(3)
...
//;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ExpandGraphic(d.compressedGraphic0,
                d.pViewportBMP,
                0,
                0);
  ...
  if (D4W == 1)
  {
    LOCAL_112 = allocateMemory(8400,0);
    TAG0088b2((ui8 *)d.pViewportBMP,
              (ui8 *)LOCAL_112,
              (RectPos *)d.Byte18576,
              0,
              ...
              112,
              -1);
    BLT2Viewport(LOCAL_112,(RectPos *)d.Byte18584,112,-1);
    FreeTempMemory(8400);
